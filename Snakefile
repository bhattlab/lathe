...
rule postprocess_raw:
	...
	output:
		"{samp}/final/prokka.tmp".format(samp=config['sample']),
		"{samp}/final/quast.tmp".format(samp=config['sample']),
		"{samp}/final/checkm.tmp".format(samp=config['sample']),
		"{samp}/final/trna.tmp".format(samp=config['sample']),
		"{samp}/final/rrna.tmp".format(samp=config['sample']),
		"{samp}/final/classify.tmp".format(samp=config['sample'])
	log:
